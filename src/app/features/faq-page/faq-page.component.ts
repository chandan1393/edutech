...
export class FaqPageComponent {
  ...
  faqs = [
    ...
    { cat: 'Payment & Refunds', q: 'Do you offer a grade guarantee?', a: 'We target A or B grades on all coursework. Our 99.1% success rate across 5,000+ completed classes reflects consistent delivery. If any deliverable falls below the agreed standard, we revise until you approve at zero extra cost.' },
