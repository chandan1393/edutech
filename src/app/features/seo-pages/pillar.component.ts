...
export class PillarComponent {
  ...
  faqs = [
    ...
    { q: 'Do you guarantee grades?', a: 'We target A or B grades on all coursework. Our 99.1% success rate across 5,000+ completed classes reflects consistent delivery. If any deliverable falls short of the agreed standard, we revise until you approve — at zero extra cost.' },
    ...
    { q: 'Will my university know I am using EduPilotHelp?', a: 'Our experts log into your portal using IP addresses that match your university region, using secure VPN protocols for every class. No third party — including your institution — can detect our involvement. Your privacy is guaranteed at every stage.' },
