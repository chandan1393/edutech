...
export class MarketingTagsService {
  ...
  /**
   * True only when a third-party tag that sets cookies is configured.
   * The cookie banner keys off this — no tags configured means this site
   * sets no cookies at all, so no consent prompt is shown.
   */
  get hasCookieSettingTags(): boolean {
